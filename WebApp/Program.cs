...
{
    Console.WriteLine("DinktoPDF no es soportado para la versi�n del Sistema Operativo");
}
...
builder.Services.AddDefaultIdentity<IdentityUser>(options => options.SignIn.RequireConfirmedAccount = true)
                .AddRoles<IdentityRole>() //Se agrega para realizar la administraci�n de roles
...
//Redireccionar las paginas de Identity que no se desean activar
//En este caso el Regitrar nuevo usuario esta deshabilitado.
